...
namespace HabitTracker.DzemalKurtic
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("\n\nPlease insert the date: (Format: dd-mm-yy). Type 0 to return to main manu. If you want to add today's date type 1.\n\n");

            string dateInput = Console.ReadLine();

            if (dateInput == "0") GetUserInput();

            if (dateInput == "1") return DateTime.Now.Date.ToString("dd-MM-yy");
